...
import { BufferAttribute, BufferGeometry, DoubleSide, Mesh, MeshBasicMaterial, Object3D, ShapeUtils, Vector3 } from 'three';
...
const bodyold = translate([1, 0, 0], jscadModeling.primitives.cuboid({ size: [1, 1, 1] }));
